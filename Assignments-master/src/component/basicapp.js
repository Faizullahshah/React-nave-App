...
export default class IScrolledDownAndWhatHappenedNextShockedMe extends Component {
  render() {
      return (
        <ScrollView>
          <Text style={styles.textBlock}> BY Syed faizullah Shah </Text>
...
const styles = StyleSheet.create({
        textBlock: {
        display:"flex",fontSize:20, height:40, textAlignVertical:"center",textAlign:"center", fontWeight:"bold",borderTopColor:'#f0f', borderBottomColor: 'black'
        ,borderBottomWidth: 1  } 
    } 
)